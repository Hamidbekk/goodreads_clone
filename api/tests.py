...
class BookReviewAPITestCase(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create(username="hamidbek2669", first_name="Hamid")
    ...
    def test_book_review_detail(self):
        ...
        self.assertEqual(response.data['user']['first_name'], 'Hamid')
        self.assertEqual(response.data['user']['username'], 'hamidbek2669')
